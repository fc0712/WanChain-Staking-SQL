...
class StakingRewardsProcessor:
    ...
    async def query_multiple_epochs(self, epochs):
        ...
        try:
            ...
            await api.close()
            logger.info("Closed API connection for epoch queries")
    ...
    async def query_multiple_block_numbers(self, block_numbers):
        ...
        try:
            ...
            await api.close()
            logger.info("Closed API connection for block queries")
    ...
    async def query_staking_pos(self):
        ...
        try:
            ...
            await api.close()
            logger.info("Closed API connection for staking position query")
